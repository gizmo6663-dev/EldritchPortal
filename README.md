...
**Engelsk versjon:** [EldritchPortals](https://github.com/gizmo6663-dev/EldritchPortals).

## Om utvikleren og hvordan appen er laget

Jeg er ikke utvikler av yrke. Eldritch Portal er bygget av en hobbyist som ønsket et praktisk verktøy til egne sesjoner, og det meste av koden er skrevet i samarbeid med KI (Claude). Dette er ikke skjult — jeg nevner det fordi jeg tenker at brukerne bør vite det:
...
- **Begrensningene:** Jeg kan ikke alltid garantere hvordan koden oppfører seg i alle edge cases, og jeg finner ikke nødvendigvis feil raskt selv. Rapporter gjerne via [Issues](https://github.com/gizmo6663-dev/EldritchPortal/issues) — jeg setter pris på alle tilbakemeldinger.
